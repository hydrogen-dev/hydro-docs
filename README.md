# hydro-docs
Documentation for Project Hydro
<H2>Introduction</H2>
<p>Project Hydro is the blockchain application of <a href="https://www.hydrogenplatform.com" target="_blank">Hydrogen</a>, an API platform that allows developers to build sophisticated fintech apps in minutes.</p>
<H3>Resources</H3>
